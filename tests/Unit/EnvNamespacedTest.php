...
use function vansbeck07\Dotenv\addEnv;
use function vansbeck07\Dotenv\allEnv;
use vansbeck07\Dotenv\Dotenv;
use function vansbeck07\Dotenv\dotenv;
use function vansbeck07\Dotenv\env;
use function vansbeck07\Dotenv\loadenv;
use function vansbeck07\Dotenv\persistenv;

class EnvNamespacedTest extends TestCase
{
    protected $envFile = '';
    protected $directEnvInstance;
